...
import shadcnLogo from '../shadcn-ui-.png' // Make sure to update the path to your actual logo file
...
const Footer = () => {
  return (
    <div>
      ...
      <img src={shadcnLogo} alt="Shadcn logo" className="w-20 h-auto" />
      <span className="ml-2">Shadcn/ui</span>
    </div>
            ...
            <div className="text-center">
              <span className="text-sm tracking-wide">
                Made with &hearts; <span id="year">4 July 2024</span> | All rights reserved
              </span>
            </div>
          </div>
        </div>
