...
const Header = () => {
  ...
  const toggleTheme = () => {
    ...
    // Optional: If you want to toggle dark mode for the entire document
    if (!darkMode) {
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <a
                ...
                className={`text-gray-600 ${
                  darkMode ? "dark:text-gray-300" : "dark:text-gray-100"
                } hover:text-gray-800 dark:hover:text-gray-100 transition`}
              >
              ...
              <button
                onClick={toggleTheme}
                className="rounded bg-gray-100 dark:bg-gray-700 p-2 text-gray-600 dark:text-gray-300 transition hover:text-gray-600/75 dark:hover:text-gray-300/75"
              >
                {darkMode ? (
              ...
              <a
                className="rounded-md bg-gray-100 dark:bg-gray-700 px-5 py-2.5 text-sm font-medium text-teal-600 dark:text-teal-300"
                href="#"
              >
                Register
              </a>
